...
def RELIEF(training, test):
    ...
    #miramos la tasa de acierto con kneigborsClassifier con 1 vecino
    ...
    for i in range(num_muestras):
        #nos quedamos con la clase y vemos si es igual
...
def main():
    ...
    for i in range(3):
        ...
        skf = StratifiedKFold(n_splits=num_particiones, shuffle=True)
